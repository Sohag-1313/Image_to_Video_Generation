...
pipe.load_lora_weights("/workspace/output_10/cogvideox-lora__optimizer_adam__steps_10__lr-schedule_cosine_with_restarts__learning-rate_1e-3/pytorch_lora_weights.safetensors", adapter_name="cogvideox-lora")
...
frames = load_image(image="/workspace/images/disney_14.png")
...
output_file = "/workspace/output_video/output_10.mp4"
fps = 8
